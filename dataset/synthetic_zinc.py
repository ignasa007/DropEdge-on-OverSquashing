...
class Tranform:
    ...
    def get_node_pairs_fn(self, split, alpha, root):
        ...
        return f'{root}/node-pairs/alpha={alpha}/{split}.pkl'
...
class SyntheticZINC(BaseDataset):
    ...
    def __init__(self, device: torch.device, others: Namespace, **kwargs):
        ...
        for split in ('train', 'val', 'test'):
            ...
            transform = Tranform(split, others.alpha, zinc_root)
        ...
        self.num_features = 1
        self.num_classes = 1
        super(SyntheticZINC, self).__init__(self.task_name)
